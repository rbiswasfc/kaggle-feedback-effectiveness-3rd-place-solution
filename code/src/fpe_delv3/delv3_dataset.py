...
#--------------- Additional Tokens ---------------------------------------------#
# USE_NEW_TOKEN_MAP = True

# TOKEN_MAP = {
#     "Lead": ["Lead: Does the lead grab the readers attention and point towards the position? [LEAD]", "[LEAD_END]"],
#     "Position": ["Position: Does the position state a clear stance closely related to the topic? [POSITION]", "[POSITION_END]"],
#     "Claim": ["Claim: Is the claim closely relevant to the position and backs up the position with specific points or perspectives? Is the claim valid and acceptable? [CLAIM]", "[CLAIM_END]"],
#     "Counterclaim": ["Counterclaim: Is the counterclaim reasonable and relevant to the position? [COUNTER_CLAIM]", "[COUNTER_CLAIM_END]"],
#     "Rebuttal": ["Rebuttal: Does the rebuttal directly answer and refute the counterclaim? [REBUTTAL]", "[REBUTTAL_END]"],
#     "Evidence": ["Evidence: Is the evidence closely related  to the claim and provides valid examples? [EVIDENCE]", "[EVIDENCE_END]"],
#     "Concluding Statement": ["Concluding Statement: Does the concluding statement effectively restates the claims using different wording? [CONCLUDING_STATEMENT]", "[CONCLUDING_STATEMENT_END]"]
# }
...
# if USE_NEW_TOKEN_MAP:
#     TOKEN_MAP = TOKEN_MAP_NEW

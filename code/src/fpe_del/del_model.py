...
class FeedbackModelEnsembleKD(nn.Module):
    """
    The feedback prize effectiveness model for fast approach
    """
    ...
    def __init__(self, config):
        ...
        super(FeedbackModelEnsembleKD, self).__init__()
        self.config = config
    ...
    def forward(
        ...
        **kwargs
        ...
        if labels is not None:
            ...
            with torch.no_grad():
                t_logits_one = teacher_one.get_logits(
                    input_ids,
                    token_type_ids,
                    attention_mask,
                    span_head_idxs,
                ...
                t_logits_two = teacher_two.get_logits(
                    input_ids,
                    token_type_ids,
                    attention_mask,
                    span_head_idxs,
                ...
                t_logits_one = t_logits_one[:, :, :self.num_original_labels]
                t_logits_two = t_logits_two[:, :, :self.num_original_labels]
                t_logits = (t_logits_one + t_logits_two)/2.0

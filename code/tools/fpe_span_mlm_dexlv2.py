...
from transformers import (AutoConfig, AutoModel, AutoModelForMaskedLM,
                          ...
                          DataCollatorWithPadding, DebertaV2ForMaskedLM,
                          DebertaV2Tokenizer, PreTrainedTokenizerBase,
...
def execute_mlm(config):
    ...
    if config["num_layers_reinit"] > 0:
        print(f"re-initializing last {config['num_layers_reinit'] } layers of the base model...")
        reinit_deberta(model.deberta, config["num_layers_reinit"])
        print("=="*40)
